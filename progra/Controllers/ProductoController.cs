...
namespace progra.Controllers
{
    public class ProductoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,Price,ImagenName,categoria")] Producto producto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,Price,ImagenName,categoria")] Producto producto)
        {
            if (id != producto.ID)
            {
                return NotFound();
